...
public:
    ...
    // constructors
    APTree() : theta(1, 0.0), Xorder(0), N(0), ID(1), v(0), c_index(0), c(0.0), depth(0), iter(0), p(0), l(0), r(0) {}
    APTree(size_t dim_theta) : theta(dim_theta, 0.0), Xorder(0), N(0), ID(1), v(0), c_index(0), c(0.0), depth(0), iter(0), p(0), l(0), r(0) {}
    APTree(size_t dim_theta, arma::umat *Xordermat) : theta(dim_theta, 0.0), Xorder(Xordermat), N(0), ID(1), v(0), c_index(0), c(0.0), depth(0), iter(0), p(0), l(0), r(0) {}
    APTree(size_t dim_theta, size_t depth, size_t N, size_t ID, APTree_p p, arma::umat *Xordermat) : theta(dim_theta, 0.0), Xorder(Xordermat), N(N), ID(ID), v(0), c_index(0), c(0.0), depth(depth), iter(0), p(p), l(0), r(0) {}
