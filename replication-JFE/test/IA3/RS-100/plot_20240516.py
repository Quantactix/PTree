...
def myplot(date, name, my_ylim, n_tick, add_legend=True):
    ...
    # colors = {'$\lambda$=1000': 'green', '$\lambda$=10': 'blue', '$\lambda$=1': 'red', '$\lambda$=1e-1': 'orange', '$\lambda$=1e-5': 'black'}
    ...
    plt.savefig('./output/'+name+'_'+date+'_avg20_random_N100_py.pdf', format='pdf', bbox_inches='tight')
