...
for (i in c(1:NSim)){
  ...
  load(paste0("./output/tab_1_20240510_complex_OOS_NSim_",i,".RData"))
  ...
  pdf(file = paste0("./output/mn_20240510_",i,".pdf"),
      width = 10,
      height = 10)
  myplot(mn)
  legend("right", 
  ...
  pdf(file = paste0("./output/sn_20240510_",i,".pdf"),
      width = 10,
      height = 10)
  myplot(sn)
  legend("right", 
  ...
  pdf(file = paste0("./output/sm_20240510_",i,".pdf"),
      width = 10,
      height = 10)
  myplot(sm)
  legend("right", 
  ...
  pdf(file = paste0("./output/sr_20240510_",i,".pdf"),
      width = 10,
      height = 10)
  myplot(sr)
  legend("right", 
  ...
  pdf(file = paste0("./output/hj_20240510_",i,".pdf"),
      width = 10,
      height = 10)
  myplot(hj)
  legend("right", 
...
pdf(file = './output/mn_20240510_avg20.pdf',
    width = 10,
    height = 10)
...
pdf(file = './output/sn_20240510_avg20.pdf',
    width = 10,
    height = 10)
...
pdf(file = './output/sm_20240510_avg20.pdf',
    width = 10,
    height = 10)
...
pdf(file = './output/sr_20240510_avg20.pdf',
    width = 10,
    height = 10)
...
pdf(file = './output/hj_20240510_avg20.pdf',
    width = 10,
    height = 10)
...
write.csv(mn,"./output/mn_20240510_avg20.csv")
write.csv(sm,"./output/sm_20240510_avg20.csv")
write.csv(sn,"./output/sn_20240510_avg20.csv")
write.csv(sr,"./output/sr_20240510_avg20.csv") # Table I.8. Panel A. Sharpe ratio.
write.csv(hj,"./output/hj_20240510_avg20.csv") # Table I.8. Panel B. Pricing Error.
